...
(DEFUN LIN-MPLUS (FORM)
  (DO ((TL (CDR FORM) (CDR TL)) (DUMMY) (COEFF 0) (REM 0))
      ((NULL TL) (CONS COEFF (MMOD REM COEFF)))
...
(DEFUN MMOD (X MOD)
  (COND ((FIXP X) (IF (MINUSP (SETQ X (- X (* MOD (// X MOD))))) (+ X MOD) X))
...
#.(SETQ EPS #+PDP10 (FSC 1.0 -26.) #-PDP10 1.4E-8)
